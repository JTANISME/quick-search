    ...
    companion object {
        ...
        fun from(
            ...
            return SearchPreferenceCache(
                ...
                unifiedPinnedItemsEnabled = prefs.unifiedPinnedItemsEnabled,
                searchHintsEnabled = prefs.searchHintsEnabled,
                settingsIconEnabled = prefs.settingsIconEnabled,
                ...
                selectedAppSuggestionTab = prefs.selectedAppSuggestionTab,
                enabledAppSuggestionTabs = prefs.enabledAppSuggestionTabs,
                showAppLabels = prefs.showAppLabels,
                phoneAppGridColumns = prefs.phoneAppGridColumns,
                appIconSizeStep = prefs.appIconSizeStep,
                appIconShape = prefs.appIconShape,
                launcherAppIcon = prefs.launcherAppIcon,
                themedIconsEnabled = prefs.themedIconsEnabled,
                deviceThemeEnabled = prefs.deviceThemeEnabled,
